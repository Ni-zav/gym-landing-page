<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
    <div class="max-w-[1200px] mx-auto w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-base">
        <div class="flex flex-col gap-4 md:col-span-2">
            ...
            <p>©2023 Hello Brother Ltd. All rights reserved.</p>
        </div>
        <div class="flex flex-col gap-4">
            <p class="font-bold generalSans text-base sm:text-lg">Support</p>
            <a
                href=""
                target="_blank"
        ...
        <div class="flex flex-col gap-4">
            <p class="font-bold generalSans text-base sm:text-lg">Research</p>
            <a
                href=""
                target="_blank"
                class="cursor-pointer hover:text-indigo-400 duration-200"
        ...
        <div class="flex flex-col gap-4">
            <p class="font-bold generalSans text-base sm:text-lg">Follow Us</p>
            <a
                href=""
                target="_blank"
                class="cursor-pointer hover:text-indigo-400 duration-200"
