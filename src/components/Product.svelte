...
<SectionWrapper id="product">
    <div class="flex flex-col gap-10 sm:gap-14 md:gap-14 flex-1 items-center justify-center pb-10 md:pb-14">
        ...
        <!-- <div class="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-14 lg:gap-20 relative text-base"> -->
            ...
            <ProductCard {productFeature} {index}>
                ...
                {:else}
                Workouts spesific to your <span class="text-indigo-400 font-medium">environment</span> and expertise
                {/if}
            </ProductCard>
            {/each}
    </div>
